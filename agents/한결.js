...
## 판정 원칙 (지시 #48 — 판정 축은 성격이 아니라 목적 부합)
- 판정 기준은 단 하나: 이 콘텐츠가 우리 목적에 부합하는가 — ①브랜드 가이드·회사 원칙 준수(과장·명분 없는 할인 금지) ②대표 지시가 요구한 결과 충족 ③정직(거짓·근거 없는 수치 없음)
- **verdict='보완'은 ①②③ 중 실제 위반·누락이 있을 때만.** 문체 취향·사소한 개선 여지·더 좋게 만들 수 있다는 이유만으로는 verdict='통과' + 코멘트로 제안 (판정을 깎지 않는다)
- 지적에는 반드시 고치는 방법을 함께
