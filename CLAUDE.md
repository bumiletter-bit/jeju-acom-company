...
> - **심사 추적 중 = 총 9장**: 텍스트형 UJ_9084~9087(+구본 9082) + 이미지형 UJ_9135~9138 — 전부 R/REQ(7/30 오전 교차 검수 실측. 폴링 턴마다 영업시간대 재확인, selftest의 senderkey_template_list.templates 필드). **승인 시 이미지형이 본판(env에 UJ_9135~9138)·텍스트형은 폴백(#100 전략) — 최종 투입값은 승인 결과 보고 대표 확정.**
