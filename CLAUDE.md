...
- **미완·후속 (다음 깨우기 때 처리)**:
  ...
  ② **#138 잔여**: 릴레이 2026-07-31.1 SSH 갱신(#159에 절차 게시) 확인되면 → relay_health_request로 버전 실측 → aligo_template_del_request {go:'yes', codes:['UJ_9082','UJ_9135','UJ_9136','UJ_9137','UJ_9138']} 재발동 → 삭제 → 최종 템플릿 상태표 보고.
