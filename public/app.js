...
const PRODUCT_CATALOG = new Set([
    ...
    '고당도 비가림귤 / 상품 및 과수: 소과 - 3kg(가정용 2S미만)',
    '과즙팡팡 천혜향 / 상품 및 과수: 꼬마 천혜향 가정용 - 5kg(30과 전후)',
    '과즙팡팡 천혜향 / 상품 및 과수: 꼬마 천혜향 가정용 - 9kg(55과 전후)',
    '고급 하우스 한라봉 / 상품 및 과수: (★특가)꼬마 한라봉 - 5kg(30과 전후)',
    '고급 하우스 한라봉 / 상품 및 과수: (★특가)꼬마 한라봉 - 9kg(54과 전후)',
]);
...
function matchProduct(rawText) {
    ...
    if (/3종세트|레드향.*한라봉.*천혜향|한라봉.*천혜향.*레드향/.test(t)) {
        ...
        } else if ((/꼬마/.test(t) || /특가/.test(t)) && fruit === '한라봉') {
            const detail = w === 5 ? '30과 전후' : w === 9 ? '54과 전후' : '';
            result = '고급 하우스 한라봉 / 상품 및 과수: (★특가)꼬마 한라봉 - ' + wStr + '(' + detail + ')';
