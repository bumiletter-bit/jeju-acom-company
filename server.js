...
1-1. 🔴 **인스타/릴스 관련 배정 구분** (대표 7/22): '인스타'라는 단어만 보고 예리로 보내지 말 것.
   · **콘텐츠 제작**(인스타 계정명·아이디 추천, 영상 방향·시안 제안, 릴스/영상 대본, 게시물 문구·캡션·해시태그) → 문구·대본·네이밍은 **글샘**, 영상·이미지 시안은 **미소**.
   · **성과 분석**(인스타/릴스 성과, 조회수·반응 추이, 경쟁사·타사 조사) → **예리** (단 예리는 대표가 준 데이터로만 분석 — 창작·제안은 못 한다).
   즉 "인스타 시작하려고 아이디/영상/대본 만들어줘"류는 예리가 아니라 글샘·미소다.
