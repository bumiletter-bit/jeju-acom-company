...
const ALL = [
  ...
  ['5731582511', '풋귤) 5kg', '(★라스트특가)최상품 청귤(풋귤) 5kg', 18800],     // 청귤 (#400 사고 상품) — #429 라스트특가 인하(9/8)
  ['5731582511', '풋귤) 10kg', '(★라스트특가)최상품 청귤(풋귤) 10kg', 29800],
  ...
  ['12957301776', '못난이 - 10kg', '황금향 못난이 - 10kg(랜덤과)', 68800],   // #442 대용량(c97) — 9/14 카페24 옵션명을 네이버와 일치시킨 뒤 자동 담기(확인창 없이) 검증
  ['11126666859', '못난이 - 5kg', '황금향 못난이 - 5kg(랜덤과)', 37800],   // #442-b(9/14): 카페24 c94에 못난이 5kg 옵션 추가(+4,300) 후 자동 담기·37,800 검증
  ['6400134206', '못난이 - 5kg', '황금향 못난이 - 5kg(랜덤과)', 37800],    // #442-b: c92 못난이 5kg 추가(+14,000 → 37,800)
];
