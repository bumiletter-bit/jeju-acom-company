...
const CASES = [
    ...
    ['보내는사람 : 류 현', '김류현', '류현'],   // 두 글자 이름은 구매자 이름의 일부일 때만(#455-b)
    ['보내는사람 : 류 현', '김구매', 'AMB'],
    ['보내는이 김수정 변경', '김구매', '김수정'],
    ...
    // #455 제3자 검수에서 찾은 허점 — 전부 애매(무변경)여야 한다
    ['보내는 사람 번호 010-1234-5678로 연락주세요', '김구매', 'AMB'],
    ['보내는 사람 전화번호는 010-1234-5678 입니다', '김구매', 'AMB'],
    ['보내는이 본인으로 해주세요', '김구매', 'AMB'],
    ['보내는사람 동일', '김구매', 'AMB'],
    ['보내는 사람 그대로', '김구매', 'AMB'],
    ['받는사람과 보내는사람 같음', '김구매', 'AMB'],
    ['보내는 사람 없음', '김구매', 'AMB'],
    ['보내는이 비공개로 변경', '김구매', 'AMB'],
    ['보내는이 홍길동 변경. 받는분 연락처 010-9999-8888 로 연락주세요', '김구매', 'AMB'],
    ['받는분 김영희, 보내는분 홍길동', '김구매', 'AMB'],
    ['경비실에 맡겨 드림', '김구매', 'AMB'],
    ['사과 드림', '김구매', 'AMB'],
    ['보내는이 홍길동 변경, 보내는이 김철수 변경', '김구매', 'AMB'],
    ['보내는이 김미로 변경', '김구매', 'AMB'],
    // #455 번호는 이름 바로 뒤일 때만 — 떨어진 번호는 버리고 이름만
    ['보내는이 홍길동 변경 부재시 010-9999-8888', '김구매', '홍길동', null],
    ['보내는이: 가나환경 홍길동 연락처: 01012345678', '김구매', '가나환경 홍길동', '010-1234-5678'],
    ['보내는이 김미로로 변경', '김구매', '김미로'],
    ['보내는이 김동일 변경', '김구매', '김동일'],
    ['엄마 드림', '김구매', '엄마'],
    ['부재시 문앞. 아들 올림', '김구매', '아들'],
    // #455-b 홀드아웃(이름처럼 생기지 않은 말) — 전부 애매(무변경)
    ['보내는 사람 미표기', '김구매', 'AMB'],
    ['보내는이 공란', '김구매', 'AMB'],
    ['보내는 사람 아꼼이네로 해주세요', '김구매', 'AMB'],
    ['보내는 사람 알 수 없게', '김구매', 'AMB'],
    ['보내는이 회사명으로 변경', '김구매', 'AMB'],
    ['보내는 이 바꿔주실 수 있나요', '김구매', 'AMB'],
    ['기사님 수고 많으십니다. 음료 드림', '김구매', 'AMB'],
    ['경비실 맡겨주세요. 미리 인사 드림', '김구매', 'AMB'],
    ['늦어도 괜찮아요. 천천히 보내 드림', '김구매', 'AMB'],
    ['보내는이 가나다라 변경요', '김구매', 'AMB'],
    ['항상 잘 먹고 있어요. 단골 올림', '김구매', 'AMB'],
    ['보내는 사람 이름은 안 적어주셔도 됩니다', '김구매', 'AMB'],
    ['보내는이 변경 없음', '김구매', 'AMB'],
    ['보내는 사람 위와 동일', '김구매', 'AMB'],
    ['보내는 사람 홍길동 / 받는 사람 김영희', '김구매', 'AMB'],
    ['보내는이 홍길동 010-1234-5678 받는이 010-9999-8888', '김구매', 'AMB'],
    ['보내는 사람: (주)가나다 홍길동 대표', '김구매', '(주)가나다 홍길동 대표'],
    ['가나다 임직원 일동 드림', '김구매', 'AMB'],   // 회사 표식 없는 단체명은 애매(#455-c)
    ['한가위 선물입니다. 가나산업 임직원 일동 올림', '김구매', '가나산업 임직원 일동'],
    ['보내는이 황보석 변경', '김구매', '황보석'],
    ['보내는이 심부름 변경', '김구매', 'AMB'],
    ['김영수가 드림', '김구매', 'AMB'],
    ['김영수 드림 / 문앞', '김구매', 'AMB'],
    ['보내는이 김영수 → 박서준 변경', '김구매', 'AMB'],
    ['보내는 사람 김영수에서 박서준으로 변경', '김구매', 'AMB'],
    ['보내는 사람 김영수 변경 부탁드리고 도착하면 010-3333-4444로 전화주세요', '김구매', '김영수', null],
    ['보내는이 김영수, 연락처 010-3333-4444', '김구매', '김영수', '010-3333-4444'],
    ['보내는 사람 병원으로 변경', '김구매', 'AMB'],
    ['보내는이 카페 사장', '김구매', 'AMB'],
    ['정성껏 드림', '김구매', 'AMB'],
    ['서비스 드림', '김구매', 'AMB'],
    ['보내는이 하나만 변경', '김구매', 'AMB'],
    ['보내는 사람 홍길동 아니고 김철수', '김구매', 'AMB'],
    ['보내는이 한라봉으로 변경', '김구매', 'AMB'],
    ['보내는 사람 정확히 기재', '김구매', 'AMB'],
    ['보내는이 Hong Gildong 변경', '김구매', 'Hong Gildong'],
    ['김영희님께 보내는 사람 홍길동', '김구매', '홍길동'],
    // 무관 → null
    ['문 앞에 놔주세요', '김구매', null],
    ['', '김구매', null],
